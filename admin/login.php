<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT COUNT(*) as cntusr FROM login_data WHERE username = '".$myusername."' and password = MD5('".$mypassword."')";
    ...
    <body>
		...
		<div id="login" class="signin-card">
			<div class="logo-image">
			  	<img src="./assets/images/mystrix_fill_black.svg" alt="Logo" title="Logo" width="140">
			</div>
			<h1 class="display_mystrix"><b>MYSTRIX</b></h1>
			<p class="subhead">www.mystrix.in</p>
			<form method="post" id="login-form" accept-charset="UTF-8">
	
				<div id="form-login-username" class="form-group">
	    			<input id="username" class="form-control" name="username" type="text" size="18" alt="username" required>
	    		...
	    		<div align="left">
	      			<button class="btn btn-block btn-info ripple-effect" type="submit" value = "Submit" name="Submit" alt="sign in">Sign In</button>  
		  		</div>
